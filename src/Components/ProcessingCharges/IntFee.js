...
function IntFee() {
 ...
 <Breadcrumb.Item active>International author fee</Breadcrumb.Item>
</Breadcrumb>

        <Container fluid>
            <Row>
                <Col xl={8} lg={8} sm={12} className='mt-2'>
                <h1 style={{color:'#A01E1E',textAlign:'center',marginBottom:'2rem'}}>Processing Charges (International author)</h1>
                <Container>
      ...
      <thead>
        <tr>
          ...
          <th style={{textAlign:'center',backgroundColor:'#A01E1E',fontWeight:600,color:'white',fontSize:'20px'}}>International Authors</th>
      ...
      <tbody>
        <tr>
          ...
          <td style={{textAlign:'center',color:'green'}}><p style={{textAlign:'center',color:'#302CD4',fontWeight:600}}>40USD</p>
