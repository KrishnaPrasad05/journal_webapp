...
function ProcessingChargesComp() {
 ...
 <Breadcrumb.Item active>Processing Charges</Breadcrumb.Item>
</Breadcrumb>
        <Container fluid>
            <Row>
                <Col xl={8} lg={8} sm={12} className='mt-2'>
                <h1 style={{color:'#A01E1E',textAlign:'center',marginBottom:'2rem'}}>Processing Charges</h1>
                <Container>
...
export default ProcessingChargesComp