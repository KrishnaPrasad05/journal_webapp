      ...
      <Navbar.Toggle aria-controls="basic-navbar-nav" className="ms-auto bg-light" />
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto" style={{ justifyContent: 'space-between', width: '100%' }}>
            <Nav.Link as={Link} to="/reviewer-home" className='text-light' style={{fontSize:'18px'}}>Home</Nav.Link>
            <Nav.Link as={Link} to="/reviewer-about-us" className='text-light' style={{fontSize:'18px'}}>About Us</Nav.Link>
            ...
            <NavDropdown title={<span style={{ color: 'white',fontSize:'18px' }}>Editorial Board</span>} id="navbarScrollingDropdown" className="custom-dropdown">
              <NavDropdown.Item as={Link} to="/reviewer-editor-desk">Editorial Desk</NavDropdown.Item>
              <NavDropdown.Item as={Link} to="/reviewer-board">
                Board
              </NavDropdown.Item>
            </NavDropdown>
            <Nav.Link as={Link} to="/reviewer-impact-factor" className='text-light' style={{fontSize:'18px'}}>Impact Factor</Nav.Link>
            
            
            <Nav.Link as={Link} to="/paper-review" className='text-light' style={{fontSize:'18px'}}>Review Paper</Nav.Link>
            <Nav.Link as={Link} to="/reviewer-guidelines" className='text-light' style={{fontSize:'18px'}}>Guidelines</Nav.Link>
            <Nav.Link as={Link} to="/reviewer-announcements" className='text-light' style={{fontSize:'18px'}}>Announcements</Nav.Link>
            <Nav.Link as={Link} to="/reviewer-contact-us" className='text-light' style={{fontSize:'18px'}}>Contact Us</Nav.Link>
            <Nav.Link as={Link} to="/reviewer-profile" className='text-light' style={{fontSize:'18px'}}>Profile</Nav.Link>
