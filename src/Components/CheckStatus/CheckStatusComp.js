 ...
 <Breadcrumb.Item active>Check Paper Status</Breadcrumb.Item>
      ...
      <Container fluid>
        <Row>
          ...
          <h1 style={{color:'#A01E1E',textAlign:'center',marginBottom:'2rem'}}>Check Paper Status</h1>
          <Container>
            <Container>
                <Row className='mt-3'>
      ...
      <Table striped bordered hover style={{borderColor:'black'}}>
        <thead>
          <tr>
            ...
            <th style={{backgroundColor:'#A01E1E',color:'white',fontWeight:600,textAlign:'center',borderColor:'grey'}}>Paper ID</th>
            <th style={{backgroundColor:'#A01E1E',color:'white',fontWeight:600,textAlign:'center',borderColor:'grey'}}>Title</th>
            <th style={{backgroundColor:'#A01E1E',color:'white',fontWeight:600,textAlign:'center',borderColor:'grey'}}>Author</th>
